...
func NewMnemonic(entropy []byte) (string, error) {
  ...
  for i := sentenceLength - 1; i >= 0; i-- {
    ...
    words[i] = Words[binary.BigEndian.Uint16(wordBytes)]
  }

  return strings.Join(words, " "), nil
}

// ToByteArray takes a mnemonic string and turns it into a byte array
...
func ToByteArray(mnemonic string) ([]byte, error) {
